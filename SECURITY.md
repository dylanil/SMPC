...
This is an educational **demonstration project**, not a production or commercial service. The security goal is narrow: show the mechanics of secure aggregation honestly, with the important limits visible.
